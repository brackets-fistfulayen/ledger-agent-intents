...
| `LEDGER_API_KEY` | Ledger Developer Portal origin token (server-side proxy) | Yes |
...
| Variable | Description | Default |
|----------|-------------|---------|
| `LEDGER_API_KEY` | Ledger Developer Portal origin token (server-side proxy) | (required) |
