# Agent Payments with Ledger — Circle USDC Hackathon
...
### 2. Ledger Live App: "Agent Payments with Ledger"
...
2. Ian opens Ledger Live, sees intent in Agent Payments with Ledger app
